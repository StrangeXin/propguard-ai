...
export const locales: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "auth.no_account_register_hint": "Don't have an account? Click here to register →",
    "auth.already_registered_login_hint": "Already have an account? Click here to log in →",
  ...
  zh: {
    ...
    "auth.no_account_register_hint": "没有账号？点这里去注册 →",
    "auth.already_registered_login_hint": "已有账号？点这里去登录 →",
